...
![メモリーセット画面](./frontend/src/assets/memoryset.png)
...
* **自作のメモリーセットで対戦できる**
* **自分が持っていないメモリーセットでも、友人が持っていれば一緒に遊べる**
...
ゲームを開くたびに雰囲気が変わることで、暗記を繰り返しても飽きにくい画面設計を目指しました。
